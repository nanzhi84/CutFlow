...
class WarningCode(str, Enum):
    ...
    font_glyph_fallback = "font.glyph_fallback"
    caption_composition_fallback = "caption.composition_fallback"
    tts_timing_unavailable = "tts.timing_unavailable"
    bgm_planning_failed = "bgm.planning_failed"
...
class ArtifactKind(str, Enum):
    ...
    plan_window_queries = "plan.window_queries"
    plan_window_material_retrieval = "plan.window_material_retrieval"
    ...
    plan_caption_composition = "plan.caption_composition"
    plan_bgm_diagnostics = "plan.bgm_diagnostics"
